...
const driversRoutes = require("./routes/adminDrivers.routes");
const adminTripsRoutes = require("./routes/adminTrips.routes");
const studentsRoutes = require("./routes/students.routes");
const dashboardRoutes = require("./routes/dashboard.routes");
const adminRatingsRoutes = require("./routes/adminRatings.routes");
const tripsRoutes = require("./routes/userTrips.routes");
const activityRoutes = require("./routes/activity.routes");
const walletRoutes = require("./routes/wallet.routes");
const cardRoutes = require("./routes/userCard.routes");
